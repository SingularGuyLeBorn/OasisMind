    ...
    return (
      <div className="kp-force-light kp-home-surface relative w-full overflow-x-hidden">
        ...
        <div className="relative mx-auto max-w-3xl px-6 py-10 text-center">
          ...
          <Link
            href="/gardens"
            className="mt-4 inline-flex items-center rounded-full bg-[var(--kp-brand)] px-4 py-2 text-sm font-semibold text-white shadow-[0_8px_22px_-8px_rgba(0,135,235,0.5)] transition hover:bg-[var(--kp-brand-dark)]"
          >
            返回列表
          </Link>
        </div>
    ...
    <div className="kp-force-light kp-home-surface relative w-full overflow-x-hidden">
      ...
      <div className="relative mx-auto w-full max-w-3xl px-6 py-8 pb-16 lg:px-10 lg:py-12">
        <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
          <Link
            href="/gardens"
            className="inline-flex items-center gap-1 rounded-full border border-white/60 bg-white/55 px-3 py-1.5 text-sm text-[var(--kp-text-2)] shadow-sm backdrop-blur-md transition hover:border-[var(--kp-brand)]/35 hover:text-[var(--kp-brand)]"
          >
          ...
          <div className="flex gap-2">
            <Link
              ...
              className="inline-flex items-center gap-1 rounded-full border border-white/70 bg-white/70 px-3.5 py-1.5 text-sm font-medium text-[var(--kp-text-2)] backdrop-blur-md transition hover:border-[var(--kp-brand)]/35 hover:text-[var(--kp-brand)]"
            >
            ...
            <Link
              ...
              className="inline-flex items-center gap-1 rounded-full bg-[var(--kp-brand)] px-3.5 py-1.5 text-sm font-semibold text-white shadow-[0_8px_22px_-8px_rgba(0,135,235,0.5)] transition hover:bg-[var(--kp-brand-dark)]"
            >
        ...
        <section className="kp-card-topline kp-card-sheen mb-12 rounded-[1.75rem] border border-white/55 bg-white/55 p-6 shadow-[0_16px_48px_-20px_rgba(0,80,160,0.22)] backdrop-blur-xl sm:p-8">
          <PostContent
              ...
              {posts.items.map((p) => (
                <li key={p.id}>
                  <Link
                    ...
                    className="kp-card-topline block rounded-[1.25rem] border border-white/55 bg-white/50 px-4 py-3 text-sm shadow-[0_10px_28px_-16px_rgba(0,80,160,0.14)] backdrop-blur-xl transition hover:border-[var(--kp-brand)]/35 hover:bg-white/75"
                  >
