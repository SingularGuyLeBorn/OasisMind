...
3. [Harness 层 · Agent 运行时](3-Harness层-Agent运行时/3-Harness层-Agent运行时) — 验证门控、Auto-Research；产品 harness 回 llm-guide 13
4. [Artifact 层 · 产物发现](4-Artifact层-产物发现/4-Artifact层-产物发现) — 科研 agent、算法发现
