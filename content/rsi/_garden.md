...
2. [Model 层 · 训练时自改进](2-Model层-训练时自改进/2-Model层-训练时自改进) — SPIN、Self-Rewarding、Tufa、SEAL；OPD 回 llm-guide 4.6
3. [Harness 层 · Agent 运行时](3-Harness层-Agent运行时/3-Harness层-Agent运行时) — 验证门控、ADAS、STOP、Gödel Agent、DGM；产品 harness 回 llm-guide 13
