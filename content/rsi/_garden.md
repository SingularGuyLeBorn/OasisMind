...
2. [Model 层 · 训练时自改进](2-Model层-训练时自改进/2-Model层-训练时自改进) — SPIN、Self-Rewarding、Tufa、SEAL、LADDER、Absolute Zero、R-Zero、ReTool、ToolRL、ToRL、Gorilla；OPD 回 llm-guide 4.6
