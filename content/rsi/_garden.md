...
2. [Model 层 · 训练时自改进](2-Model层-训练时自改进/2-Model层-训练时自改进) — SPIN、Self-Rewarding、Tufa、SEAL、LADDER；OPD 回 llm-guide 4.6
3. [Harness 层 · Agent 运行时](3-Harness层-Agent运行时/3-Harness层-Agent运行时) — Argus、Auto-Research、ADAS、STOP、Gödel、DGM；产品 harness 回 llm-guide 13
