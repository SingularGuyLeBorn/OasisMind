---
title: ScoreFlow：生成器会 LoRA，Score-DPO 冻着
date: 2026-08-31
as_of: 2026-08-31
category: 多智能体协作与工作流
published: true
...
同一句「自动生成 Agent 工作流」，至少分四截。提示优化把图钉死。ADAS 线性搜代码。AFlow 用 MCTS 加算子。ScoreFlow 用分数加权的 DPO 训生成器。四截不要收成「都已经是 RSI」。[AutoFlow](../8.1.4-AutoFlow-自然语言工作流RL/8.1.4-AutoFlow-自然语言工作流RL.md) 把工作流写成自然语言程序再 RL，[MAS-GPT](../../8.2-多智能体拓扑与协作/8.2.2-MAS-GPT-一次前向吐MAS/8.2.2-MAS-GPT-一次前向吐MAS.md) 一次前向吐可执行 MAS 代码，Llama-3-70B 八列均分 65.47，不要和本表 85.3 横加。[AgentPrune](../../8.2-多智能体拓扑与协作/8.2.4-AgentPrune-时空图剪边/8.2.4-AgentPrune-时空图剪边.md) 剪边省 token，均分 89.72，不要和本表 85.3 横加。ScoreFlow 的连续空间是生成器 LoRA，不是 AutoFlow 那条 NL 程序上的策略梯度，也不要收成「都在训工作流所以已经是 RSI」。[MASS](../8.1.3-MASS-提示拓扑分阶段/8.1.3-MASS-提示拓扑分阶段.md) 分三阶段调提示再调拓扑，Gemini Pro 八列均分 78.79，不要和本表 85.3 横加。本篇只负责把 Score-DPO 这条代码工作流钉死。
...
同层：[8.1.1 AFlow](../8.1.1-AFlow-工作流MCTS/8.1.1-AFlow-工作流MCTS.md)、[8.2.1 GPTSwarm](../../8.2-多智能体拓扑与协作/8.2.1-GPTSwarm-通信图边概率/8.2.1-GPTSwarm-通信图边概率.md)、[8.1.3 MASS](../8.1.3-MASS-提示拓扑分阶段/8.1.3-MASS-提示拓扑分阶段.md)、[8.1.4 AutoFlow](../8.1.4-AutoFlow-自然语言工作流RL/8.1.4-AutoFlow-自然语言工作流RL.md)、[8.2.2 MAS-GPT](../../8.2-多智能体拓扑与协作/8.2.2-MAS-GPT-一次前向吐MAS/8.2.2-MAS-GPT-一次前向吐MAS.md)、[8.2.3 G-Designer](../../8.2-多智能体拓扑与协作/8.2.3-G-Designer-任务自适应通信图/8.2.3-G-Designer-任务自适应通信图.md)、[8.2.4 AgentPrune](../../8.2-多智能体拓扑与协作/8.2.4-AgentPrune-时空图剪边/8.2.4-AgentPrune-时空图剪边.md)、[8.2.5 MaAS](../../8.2-多智能体拓扑与协作/8.2.5-MaAS-Agent超网/8.2.5-MaAS-Agent超网.md)、[8.2.6 ANN](../../8.2-多智能体拓扑与协作/8.2.6-ANN-层状文本反传/8.2.6-ANN-层状文本反传.md)、[9.1.6 ADAS](../../../09-自动研究与科学发现/9.1-自改代码与元智能体/9.1.6-ADAS-Meta-Agent-Search/9.1.6-ADAS-Meta-Agent-Search.md)、[9.1.5 Gödel Agent](../../../09-自动研究与科学发现/9.1-自改代码与元智能体/9.1.5-Godel-Agent-自指运行时/9.1.5-Godel-Agent-自指运行时.md)、[4.1 Self-Refine](../../../04-反思批评与反馈优化/4.1-Self-Refine-任务内迭代/4.1-Self-Refine-任务内迭代.md)、[6.2.1 LATM](../../../06-工具学习与程序编排/6.2-工具创建与文档优化/6.2.1-LATM-函数缓存造工具/6.2.1-LATM-函数缓存造工具.md)、[9.1.4 STOP](../../../09-自动研究与科学发现/9.1-自改代码与元智能体/9.1.4-STOP-自教优化器/9.1.4-STOP-自教优化器.md)、[9.1.1 Argus](../../../09-自动研究与科学发现/9.1-自改代码与元智能体/9.1.1-Argus-Verification-Gated/9.1.1-Argus-Verification-Gated.md)。台阶：[10.3 可靠性](../../../10-评测与安全边界/10.3-可靠性与独立监督/10.3-可靠性与独立监督.md)。术语：[1.1](../../../01-研究框架与术语/1.1-RSI-术语辨析/1.1-RSI-术语辨析.md)。
...
3. 本花园：[AFlow](../8.1.1-AFlow-工作流MCTS/8.1.1-AFlow-工作流MCTS.md)；[GPTSwarm](../../8.2-多智能体拓扑与协作/8.2.1-GPTSwarm-通信图边概率/8.2.1-GPTSwarm-通信图边概率.md)。AFlow 原文均分 80.3 以专文为准，不要和本表重跑 80.6 横加。
