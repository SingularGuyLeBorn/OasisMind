...
| verification-gated runtime、STOP、Gödel Agent、DGM、技能包自改、ACE playbook、Voyager、Reflexion、Self-Refine、CRITIC、EASYTOOL、HuggingGPT、RestGPT | 第 3 章（Voyager / Reflexion / Self-Refine / CRITIC / EASYTOOL / HuggingGPT / RestGPT 已落） | 不要写成 Cursor 产品手册 |
