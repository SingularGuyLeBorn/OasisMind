...
| SPIN / Self-Rewarding / STaR / Self-Instruct / SEAL / LADDER / Absolute Zero / R-Zero / ReTool / ToolRL / ToRL / Gorilla | 第 2 章 | 不要把 OPD 公式抄进本库 |
| OPD / MOPD | 链 llm-guide 4.6 | 本库最多一节「不是 RSI」 |
| verification-gated runtime、STOP、Gödel Agent、DGM、技能包自改、ACE playbook、Voyager、Reflexion、Self-Refine、CRITIC | 第 3 章（Voyager / Reflexion / Self-Refine / CRITIC 已落） | 不要写成 Cursor 产品手册 |
