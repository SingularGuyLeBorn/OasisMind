...
矩阵乘 23%、FlashAttention 32.5%、每轮约 1% 算力这类落地数字，以 [第 4 章 03 AlphaEvolve](../../../09-自动研究与科学发现/9.3-科学发现与产物搜索/9.3.2-AlphaEvolve-进化编码智能体/9.3.2-AlphaEvolve-进化编码智能体.md) 所核 DeepMind 官方页为准。本篇不转述无法指回白皮书或官方 blog 的「时间表从几十年缩到几年」。产物变好、训练栈变快，默认仍是 Artifact 层，不是式 (2)。
...
机制、公式和 83 题数字见 [第 3 章 08](../../../07-记忆技能与经验/7.1-技能与跨任务经验/7.1.1-SkillEvolver-元技能/7.1.1-SkillEvolver-元技能.md)。本节不口算、不把摘要再写一遍。

### SEAGym（自进化评测环境）

机制、公式和 Table 2 数字见 [第 6 章 03](../../../10-评测与安全边界/10.2-SEAGym-Harness评测环境/10.2-SEAGym-Harness评测环境.md)。本节不口算、不把摘要再写一遍。
