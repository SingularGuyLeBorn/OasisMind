---
title: Stanford CS329A 与第三方 Agent Skill：官方课程、非官方蒸馏
as_of: 2026-09-01
category: 研究框架与术语
published: true
excerpt: >-
  第三方作者 yusenthebot 将 Stanford CS329A《Self-Improving AI Agents》公开课程材料蒸馏为单一可安装 Agent
...
tags:
  ...
  - 课程蒸馏
---
# Stanford CS329A 与第三方 Agent Skill：官方课程、非官方蒸馏

本篇是 **资源归属辨析入口**，不是机制专文。Stanford CS329A 是校方课程；`yusenthebot/stanford-ai-agent-skill` 是第三方依据公开材料制作的蒸馏仓库，不能代表 Stanford。**不搬** CS329A 讲义进花园。闭环、验证、轨迹回写的判定回 [1.1 术语](../../1.1-RSI-术语辨析/1.1-RSI-术语辨析.md)、[1.2 三层](../../1.2-Model-Harness-Artifact/1.2-Model-Harness-Artifact.md)、[1.4 综述](../../1.4-自进化Agent综述/1.4-自进化Agent综述.md)。

> **官方课程**：[Stanford CS329A《Self-Improving AI Agents》](https://cs329a.stanford.edu/)（Autumn 2025；校方课程页，核对日期 2026-09-01）
> **非官方课程蒸馏仓库**：[yusenthebot/stanford-ai-agent-skill](https://github.com/yusenthebot/stanford-ai-agent-skill)（第三方社区项目，无 Stanford 背书）
> **第三方蒸馏工具**：[kangarooking/cangjie-skill](https://github.com/kangarooking/cangjie-skill)
...
第三方仓库明示：Skill 内容来自公开课程材料与社区解读，**非官方 syllabus**；视频时间点与 reading 以该仓库的 `LECTURE_GUIDE` 为准。官方课程事实只由 Stanford 课程页承担，仓库的模块划分与摘要只代表第三方蒸馏。不要把社区蒸馏听成学校背书。

作为知识库条目，本 Skill 的价值在于把 CS329A 散落的「Verifier 分层、pass@k 预算、轨迹能否回写」收成 checklist，而不是替代完整听课。交叉阅读：[RSIBench-Data](../../../10-评测与安全边界/10.1-RSIBench-Data/10.1-RSIBench-Data.md)、[Argus](../../../09-自动研究与科学发现/9.1-自改代码与元智能体/9.1.1-Argus-Verification-Gated/9.1.1-Argus-Verification-Gated.md)。蒸馏 prefix / 产品 harness 细节回 llm-guide，不在本篇展开。
