...
- [Self-Refine](../../3-Harness层-Agent运行时/12-Self-Refine-任务内迭代/12-Self-Refine-任务内迭代.md)（NeurIPS'23）、[Reflexion](../../3-Harness层-Agent运行时/11-Reflexion-言语反思记忆/11-Reflexion-言语反思记忆.md)（ICLR'24）、CRITIC（arXiv'25）
