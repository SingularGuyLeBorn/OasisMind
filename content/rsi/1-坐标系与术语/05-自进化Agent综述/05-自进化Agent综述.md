...
| 代码级工作流当空间 | Harness（元 Agent 常冻） | ADAS；[AFlow](../../3-Harness层-Agent运行时/43-AFlow-工作流MCTS/43-AFlow-工作流MCTS.md)；[ScoreFlow](../../3-Harness层-Agent运行时/45-ScoreFlow-Score-DPO工作流/45-ScoreFlow-Score-DPO工作流.md)；[MaAS](../../3-Harness层-Agent运行时/51-MaAS-Agent超网/51-MaAS-Agent超网.md) 五列均分 83.59；Gödel 才把运行时打开 |
