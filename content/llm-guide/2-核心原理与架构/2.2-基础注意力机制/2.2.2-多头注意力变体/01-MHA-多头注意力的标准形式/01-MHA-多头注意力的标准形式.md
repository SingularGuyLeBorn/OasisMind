...
![](./images/redrawn-fig-scaled-dot-product-attention.png)
...
![](./images/redrawn-fig-multi-head-attention.png)
...
RoPE(Rotary Position Embedding)通过旋转矩阵把位置信息写入 Q/K 的相位结构.Llama,Qwen,DeepSeek 等主流模型在 MHA/GQA 路径上普遍采用 RoPE.后续 [04 MLA](../04-MLA-低秩潜变量与矩阵吸收.md) 会把 RoPE 与低秩 KV 压缩**解耦**,那是变体层的事;在标准 MHA 里,RoPE 直接作用在各头的 Q/K 上.
...
![Decode 时 KV 头数:MHA / GQA / MQA](./images/redrawn-fig-mha-gqa-mqa-kv-heads.png)
...
![](./images/redrawn-fig-transformer-architecture.png)
