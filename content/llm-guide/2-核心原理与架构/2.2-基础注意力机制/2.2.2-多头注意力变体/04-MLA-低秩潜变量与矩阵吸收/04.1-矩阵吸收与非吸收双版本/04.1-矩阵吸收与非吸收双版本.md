---
title: "04.1 · MLA 矩阵吸收与非吸收双版本"
date: 2026-08-30
as_of: 2026-08-30
---

# 04.1 · MLA 矩阵吸收与非吸收双版本

> 前置:[04 MLA — 低秩潜变量与解耦式注意力](../04-MLA-低秩潜变量与矩阵吸收.md)

[04 篇](../04-MLA-低秩潜变量与矩阵吸收.md) 已经定义了 MLA 的 **数学对象**($c^{KV}, c^Q, k^R$ 与解耦 RoPE).本篇**不重推 latent**,只回答 **工程落地**:同一套 checkpoint,Prefill 与 Decode 为何走两条计算图?非吸收(MHA mode)与吸收(MQA mode)如何 **代数等价**?DeepSeek-V3 参数下何时切换更省 FLOPs / 激活?
...
与 [04 篇图 2](../04-MLA-低秩潜变量与矩阵吸收.md) 同源(DeepSeek-V2 Figure 2 MLA 放大图).本篇读图时额外强调 **哪些框对应「非吸收 / 吸收」共用**:
...
![非吸收流图(MHA mode / Prefill)](./images/redrawn-fig-mla-nonabsorb-prefill.png)
...
![吸收流图(MQA mode / Decode)](./images/redrawn-fig-mla-absorb-decode.png)
