...
上一篇：[06 Gated Attention](../06-Gated-Attention-SDPA输出门控/06-Gated-Attention-SDPA输出门控.md)（token 维 SDPA 输出门，残差仍是 $x+F(x)$）。残差主干上的加宽与读门见 [2.1.3](../../../2.1-深度学习基础组件/2.1.3-残差连接/2.1.3-残差连接.md)。
