...
- 状态：用户 Goal 续跑：成体系补专文 + 配图 + 人味。Loop Transformer 已入库。4.4：DPO / ORPO / CISPO / SAPO / RLAIF 已入库。正在开 4.4.4 的 SLiC/RRHF/IPO 专文 + 4.4.1 空位 10 REINFORCE。
- 当前波次：**SLiC / RRHF / IPO 专文** + **序列级 REINFORCE**。wave-2 四张仍在跑；`fig-moe-router-top2` 不重画。不要抢 `4.6.2`。
