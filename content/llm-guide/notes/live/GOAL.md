...
- 状态：`P0-B` 尾巴已落盘；**0.8 本轮：6.1.1 BPT（2305.19370 / NeurIPS 2023）一层 $2bsh$；Table 2 同行 8× vanilla；不是 Ring / SP**
- 当前波次：**0.8 持续**（第 2/6/9 章已无活外链配图。第 5 章转载不要优先；Connest5 留条）
- 当前正在写的文章路径：下一会话从 PLAN 第 1 件 = 0.8（**Memory Efficient Attention**，Rabe & Staats 2112.05682；不要和 FA 揉成一篇）
