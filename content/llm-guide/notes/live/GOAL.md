...
- 状态：用户 Goal 续跑：成体系补专文 + 配图 + 人味。Loop Transformer 已入库。4.4：DPO / ORPO / CISPO / SAPO 已入库并接进地图。正在给 RLAIF / 4.4.4 配浅色图。
- 当前波次：**RLAIF 配图** + **4.4.4 SLiC/RRHF/IPO 浅色图**。wave-2 三张仍在跑；`fig-moe-router-top2` 不重画。不要抢 `4.6.2`。
