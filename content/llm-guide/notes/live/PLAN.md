...
1. **立刻做：** 回收 Online IPO（4.4.4/08，2403.08635）与 BOND（4.4.4/09，2407.14622）。交卷后链进 4.4.4。
2. **并行：** 继续补 4.4；同层满 10 先拆小节。不要发 4.4.1/11。4.4.4 本波之后到 09，下一波不要发 11。
...
- 上一件：入库 OAIF（4.4.2/06），链进地图。
- 现在立刻做：派 Online IPO / BOND。不要 `move_agent_to_root`。不要 push。
...
| oipo-444 | running | `4.4.4-其他对齐技术/08-Online-IPO-在线偏好/` + inbox `oipo-444.md` | 2403.08635；在线 IPO ≠ 离线 IPO 靶心故事；不是 Nash-MD 几何混合；不要改 4.4.4 节首页 |
| bond-444 | running | `4.4.4-其他对齐技术/09-BOND-Best-of-N蒸馏/` + inbox `bond-444.md` | 2407.14622；把 BoN 蒸馏回策略；不是 Gao 解码 BoN；不要改 4.4.4 节首页 |
