...
1. **立刻做：** 派下一波 4.4：Self-Rewarding（4.4.2/07，2401.10020）、WARP（4.4.4/10，2406.16768）、Dr.GRPO（4.4.6/03，2503.20783）。不要改别人的专文和节首页。
...
- 上一件：入库 BOND（4.4.4/09），链进地图；07 文的论文号改成 2407.14622。
- 现在立刻做：派 Self-Rewarding / WARP / Dr.GRPO。不要 `move_agent_to_root`。不要 push。
...
| srlm-442 | running | `4.4.2-无奖励模型的对齐DPO-KTO/07-Self-Rewarding-自奖励/` + inbox `srlm-442.md` | 2401.10020；自己给自己打偏好；不是 OAIF 的更强标注器；不要改 4.4.2 节首页 |
