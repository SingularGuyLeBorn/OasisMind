...
1. **立刻做：** 本波还剩：新文 **09-MOPD**、**10-OPD-报告落地对照**。**01-OPD** / **02-OPSD** / **04-SDPO** 已勘误。G-OPD / SCOPE 未核一手不升格。V4 后训练不 mkdir。禁止改 `4.6-OPD.md` 节首页（监工收）。
...
- 上一件：0.8 已勘误 **04-SDPO**（2601.20802；rich feedback 自教师换 GRPO 的 $A$；不是塞进 DPO）。
- 现在立刻做：**10-OPD-报告落地对照** 已交卷，立刻质检入库；**09-MOPD** 仍在写。不要 `move_agent_to_root`。不要 push。
