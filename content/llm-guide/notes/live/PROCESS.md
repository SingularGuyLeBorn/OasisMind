...
- 正在读：PowLU arXiv:2605.25704；Gated Attention 2505.06708。
- 正在写：配图波 fig-dp-611 / fig-fa-v14 / fig-kv-family / fig-nsa-dsa / fig-gated-attnres。ffn-act 02/03/04 与 b02 并行。
- 卡住：`move_agent_to_root` **禁止再调**。mHC/xHC 图等 b02 交卷。
- 上次刷新记忆的时间：2026-08-30 派出配图波

## 本会话已完成（追加，不要删旧行）

| 时间 | 动作 | 读过的源（URL） | 落到哪篇笔记 |
|------|--------|-----------------|--------------|
| 2026-08-30 | 改写 PowLU §4：组件在 Ling 整层的插槽与分工，不再甩第 14 章；补 `fig-powlu-in-ling-block.png` | 2605.25704 §4.1.1 / Fig.2 / Fig.5；2510.22115；Ling-2.0 mineru §2.1 表 1 | `04-PowLU` |
