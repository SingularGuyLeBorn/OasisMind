...
- 正在读：2.4.1 机制主线重写（01/02/03/10）；报告精读五路并行。
- 正在写：moe-hp / moe-01 / moe-02 / moe-03 / moe-10。
- 卡住：04–09 错位（硬件/系统/量化），本波不加厚，下一波 git mv 到 6.1 / 6.3 / 9.1。
- 上次刷新记忆的时间：2026-08-30 用户点名 MoE 01–10 垃圾；4000 汉字规矩入库。

## 本会话已完成（追加，不要删旧行）

| 时间 | 动作 | 读过的源（URL） | 落到哪篇笔记 |
|------|--------|-----------------|--------------|
| 2026-08-30 | 回收 b07：2.3.5 收成导航；2.4 首页；MoE 01–07 | V2 Table 9；2412.19437；STE 不编数字 | `2.3.5`；`2.4`；`2.4.1` 01–07 |
