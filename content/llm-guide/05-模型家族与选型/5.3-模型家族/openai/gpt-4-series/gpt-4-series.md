...
| GPT-4 Turbo | 2023 年开发者产品更新，强调更长上下文与较低服务成本 | 官方目录标为弃用；名为“GPT-4-Turbo.pdf”的材料实际是 GPT-4 技术报告副本，不是 Turbo 架构论文 |
...
- GPT-4 技术报告明确说明出于竞争与安全考量，不披露架构（包括模型大小）、硬件、训练算力、数据构建和训练方法细节。因此“8×220B MoE”“约 1.8T 参数”等数字只能视为未证实传闻。
