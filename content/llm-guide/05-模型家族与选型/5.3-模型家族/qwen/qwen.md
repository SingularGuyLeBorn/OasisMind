...
> 核验日期：2026-09-01。这里按官方发布身份组织，不沿用旧第 14 章的人为序号；云端 SKU、上下文、价格和可用区以使用当天官方文档为准。
...
- Qwen3.8-Flash-Next 官方称其为 Qwen4 架构的早期预览，同时明确完整 Qwen4 家族仍待构建。它不是 Qwen4 发布，旧稿中的进一步预测不进入公开事实层。
