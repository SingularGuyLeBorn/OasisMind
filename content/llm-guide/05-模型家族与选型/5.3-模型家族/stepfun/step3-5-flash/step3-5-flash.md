...
> 核验日期：2026-09-01。这里以官方论文和当前模型卡为准；旧精译中的 API 价格、竞品榜单与“最强”措辞会随时间变化，不作为稳定身份字段。
...
报告还披露 4,096 张 H800、17.2T 预训练 token 与 750B mid-training token，并讨论 Muon/Polar Express 数值异常、死专家和深层专家激活爆炸。关键方法是细粒度可观测性；平滑 loss 不能证明 MoE 内部稳定。旧文章把这些经验倒推给 Step-1/2 是错误的。
