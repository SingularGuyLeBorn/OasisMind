...
> 核验日期：2026-09-01。本文区分 2024 年的模型发布与后续 API SKU；未获一手材料支持的架构推测不作为事实。
...
Step-2 的核心公开事实是“万亿级、MoE、从头训练”。官方回顾与负责人公开表述还提到部分参数共享、希望专家形成差异化。6D 并行、专家崩溃辅助损失、200B 激活参数、特定 Offload 或知识图谱预训练均没有对应的一手架构表，不能视为已证实。
