...
Z.ai 发布记录将 GLM-5.3-Flash 的 API/服务上线列为 2026 年 8 月 26 日。截至本文核验日 2026 年 9 月 1 日，官方模型仓库已经提供权重，官方技术文章也已公开；但文章只说明权重“已公开”，没有给出独立的权重发布日期。页面展示日和仓库提交日都不能自动等同于公开可下载日，因此这里不编造一个精确日期。它是 GLM-5 家族首个原生多模态模型，并从新训练的 base model 起步，不是 GLM-5.3 的量化版或蒸馏后缀。
