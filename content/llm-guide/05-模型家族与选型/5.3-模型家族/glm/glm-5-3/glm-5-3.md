...
Z.ai 官方发布文章与 API 上线发生在 2026 年 8 月 14 日；统一发布记录于 8 月 18 日登记该版本。Hugging Face 仓库的首次提交时间表明权重在 8 月 28 日公开。这里把 8 月 28 日称为“权重仓库时间”，因为它来自仓库提交记录，而不是一篇另行发布的权重公告。产品/API、发布记录与权重仓库是三类事件，不能据其中一个日期推断另外两个也已发生。
