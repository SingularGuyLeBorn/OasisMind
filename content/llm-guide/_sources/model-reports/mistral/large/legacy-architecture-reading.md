...
> 来源快照：保留旧稿供事实追溯；公开、已校勘版本见 [公开校勘页](../../../../05-模型家族与选型/5.3-模型家族/mistral/mistral.md)。
...
>  **[返回 14.14-Mistral 家族总览](../../../../05-模型家族与选型/5.3-模型家族/mistral/mistral.md)** · 已有长 D5：[企业级 MoE 与长上下文](../../../../05-模型家族与选型/5.3-模型家族/mistral/large-3/large-3.md)· 开源前代：[Mixtral D2](../../../../05-模型家族与选型/5.3-模型家族/mistral/mixtral-8x7b/mixtral-8x7b.md) · [7.4 Function Calling](../../../../7-LLM应用开发/7.4-FunctionCalling/7.4-FunctionCalling.md) · [9.4 PD 分离](../../../../9-AI工程化与基础设施/9.4-推理服务框架/9.4.1-SGLang与Prefill-Decode分离.md)
...
Infra 面博文写的是合作栈，不是自研论文：NVFP4 检查点 + vLLM，可在 Blackwell NVL72 或单机 8×A100 / 8×H100 上跑；NVIDIA 侧提到 **Blackwell 注意力/MoE kernel、prefill/decode 分离、投机解码**，目标 GB200 NVL72。PD 分离的体系解释见 [9.4](../../../../9-AI工程化与基础设施/9.4-推理服务框架/9.4.1-SGLang与Prefill-Decode分离.md)，不要在本目录再推一遍调度公式。SGLang / TRT-LLM 被点名为 Mistral 3 全家的推理后端之一。
