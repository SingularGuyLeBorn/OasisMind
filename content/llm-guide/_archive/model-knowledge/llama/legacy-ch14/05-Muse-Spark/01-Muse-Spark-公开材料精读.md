...
>  **[返回 14.3-LLaMA 家族总览](../../../../../05-模型家族与选型/5.3-模型家族/llama/llama.md)** · 枢纽：[05 核心专题](./05-Muse-Spark-核心专题.md) · 体系：[13.5.3 Agent 安全](../../../../../13-Agent/13.5-Agent应用与治理/13.5.3-Agent安全与对齐.md)
...
下一篇枢纽：[05 · Muse Spark 核心专题](./05-Muse-Spark-核心专题.md)。机制本体不在本夹展开：注意力变体见 [2.2.2](../../../../../2-核心原理与架构/2.2-基础注意力机制/2.2.2-多头注意力变体/2.2.2-多头注意力变体.md)，Agent 治理见 [13.5.3](../../../../../13-Agent/13.5-Agent应用与治理/13.5.3-Agent安全与对齐.md)。
