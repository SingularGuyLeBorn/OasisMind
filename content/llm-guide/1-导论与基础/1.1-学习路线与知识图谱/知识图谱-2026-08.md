---
title: "知识图谱-2026-08:课程依赖与主题树落点"
date: 2026-08-30
as_of: 2026-08-30
tags: [知识图谱, 学习路线, GPU, 训练优化]
published: false
excerpt: 前进线地图.第 6 章是优化手法,第 9 章是物理与系统底座,第 05 章是模型家族唯一公共入口.表里只链非空壳.
category: LLM 指南
---

# 知识图谱 · 2026-08

同心技能树在 [1.1 学习路线与知识图谱](./1.1-学习路线与知识图谱.md).本文件是 **第 1–9 章 + 第 13 章依赖图 + 主题树落点**.第 10 / 11 / 12 章已从前进线撤掉.空壳不进表.

第 9 章回答「跑在什么硬件/系统上」;第 6 章回答「怎么优化计算」.[第 05 章](../../05-模型家族与选型/05-模型家族与选型.md)统一承接选型方法,家族谱系,版本身份,技术报告精读和来源账本,不再维护平行模型目录.

![前进线骨架 1–9 与 13](./images/fig-chapter-skeleton-2026.png)

> 图 1:本库前进线的历史快照;模型知识节点现统一解释为第 05 章唯一公共入口.

**图 1 解析**

- 第 1 章只导航;第 2 章是积木基石,分叉进预训练与后训练.
- 第 9 章喂给第 6 章:先有物理底座,再谈优化手法.
- 出口是第 7 / 8 / 13 章.某次发布如何组合技术积木,只在第 05 章的对应版本正本中读取.
...
3. [9.1 硬件基础](../../9-AI工程化与基础设施/9.1-硬件基础/9.1-硬件基础.md) — 代际与 Tensor Core(正文已接到 2026 代际)
...
档:`已有` = 体系章有可读正文;`薄` = 有文但缺推导/图/2026 事实;`缺专文` = 概念只散落在第 05 章型号正本或总览一句.
...
| HC / mHC | 已有 | [01-Hyper-Connections与mHC](../../2-核心原理与架构/2.1-深度学习基础组件/2.1.3-残差连接/01-Hyper-Connections与mHC/01-Hyper-Connections与mHC.md) |
| XHC | 已有 | [02-xHC Expanded Hyper-Connections](../../2-核心原理与架构/2.1-深度学习基础组件/2.1.3-残差连接/02-xHC-Expanded-Hyper-Connections/02-xHC-Expanded-Hyper-Connections.md)(arXiv:2607.14530;主设定 $N=16,k=4$;18B 平均 44.8→48.8;mHC Table 4 不要抄进来) |
| Gated Residual / GR | 已有 | [03-Gated Residual](../../2-核心原理与架构/2.1-深度学习基础组件/2.1.3-残差连接/03-Gated-Residual/03-Gated-Residual.md)(Qwen3.8 报告 §2.2) |
| AttnRes | 已有 | [08-AttnRes](../../2-核心原理与架构/2.2-基础注意力机制/2.2.2-多头注意力变体/08-AttnRes-深度维注意力聚合/08-AttnRes-深度维注意力聚合.md)(2603.15031;深度维 softmax;不是 $G_1$/mHC/GR) |
| FFN / SwiGLU | 已有 | 见 2.1 组件;2026-08:[01-SiTU-GLU](../../2-核心原理与架构/2.1-深度学习基础组件/2.1.1-激活函数/01-SiTU-GLU/01-SiTU-GLU.md)(K3 有界 GLU) |
| PE / RoPE / ALiBi | 已有 | [01-RoPE 本体](../../2-核心原理与架构/2.1-深度学习基础组件/2.1.4-位置编码/01-RoPE本体-旋转位置编码/01-RoPE本体-旋转位置编码.md);外推 [2.5 RoPE/03 YaRN](../../2-核心原理与架构/2.5-长上下文与外推技术/RoPE/03-长度外推:从PI到YaRN的频率扩展.md) |
| MHA / MQA / GQA / MLA | 已有 | [2.2.2/04 MLA 低秩潜变量与矩阵吸收](../../2-核心原理与架构/2.2-基础注意力机制/2.2.2-多头注意力变体/04-MLA-低秩潜变量与矩阵吸收/04-MLA-低秩潜变量与矩阵吸收.md) |
...
| ScissorHands | **已有专文** | [16-ScissorHands](../../2-核心原理与架构/2.3-高效与稀疏注意力/2.3.2-稀疏与压缩注意力/16-ScissorHands-重要性持久/16-ScissorHands-重要性持久.md)(2305.17118;pivotal 持久;5×=KV 内存;20× 只在会场摘要) |
...
| QSA | 已有 | [08 QSA](../../2-核心原理与架构/2.3-高效与稀疏注意力/2.3.2-稀疏与压缩注意力/08-QSA-Qwen稀疏注意力/08-QSA-Qwen稀疏注意力.md)($K_B=512$ 块预算;7.6× kernel ≠ 8.6× serving) |
...
| KDA | 已有 | [01 Kimi Delta Attention](../../2-核心原理与架构/2.3-高效与稀疏注意力/2.3.3-线性注意力机制/01-Kimi-Delta-Attention-KDA/01-Kimi-Delta-Attention-KDA.md)(arXiv:2510.26692) |
| MoE 路由 | 已有 | [2.4.1 MoE](../../2-核心原理与架构/2.4-前沿架构与变体/2.4.1-混合专家模型MoE/2.4.1-混合专家模型MoE.md),[01 DeepSeek-MoE](../../2-核心原理与架构/2.4-前沿架构与变体/2.4.1-混合专家模型MoE/01-DeepSeek-MoE/01-DeepSeek-MoE.md),[10 Stable LatentMoE / QB](../../2-核心原理与架构/2.4-前沿架构与变体/2.4.1-混合专家模型MoE/10-Stable-LatentMoE与Quantile-Balancing/10-Stable-LatentMoE与Quantile-Balancing.md) |
...
| PPO / RLHF | 已有 | [4.4.1 PPO](../../4-后训练/4.4-对齐技术/4.4.1-基于奖励模型的RL-RLHF-PPO/04-PPO/04-PPO.md) |
| DPO / KTO / ORPO | 已有 | [4.4.2](../../4-后训练/4.4-对齐技术/4.4.2-无奖励模型的对齐DPO-KTO/4.4.2-无奖励模型的对齐DPO-KTO.md) |
| GRPO / GSPO | 已有 | [02-GRPO](../../4-后训练/4.4-对齐技术/4.4.1-基于奖励模型的RL-RLHF-PPO/02-GRPO/02-GRPO.md),[03-GSPO](../../4-后训练/4.4-对齐技术/4.4.1-基于奖励模型的RL-RLHF-PPO/03-GSPO/03-GSPO.md) |
| RLAIF | 已有 | [4.4.3 RLAIF](../../4-后训练/4.4-对齐技术/4.4.3-RLAIF/4.4.3-RLAIF.md) |
| 蒸馏 / OPD | 已有 | [4.6 OPD](../../4-后训练/4.6-OPD/4.6-OPD.md) · [01-OPD-学生前缀蒸馏](../../4-后训练/4.6-OPD/01-OPD-学生前缀蒸馏/01-OPD-学生前缀蒸馏.md)(On-Policy Distillation,不是 Online Preference;Table 21 分母:Qwen3-8B / math+code / 17920 vs 1800) · [02-OPSD](../../4-后训练/4.6-OPD/02-OPSD-参考解自蒸馏/02-OPSD-参考解自蒸馏.md)(特权上下文自教师;37.1→43.4 是三集平均) · [03-SDFT](../../4-后训练/4.6-OPD/03-SDFT-示范持续学习/03-SDFT-示范持续学习.md)(示范 $d$ 当特权上下文;70.6/65.4 是 Table 5 单任务 Tool Use,不是顺序三任务) · [04-SDPO](../../4-后训练/4.6-OPD/04-SDPO-环境反馈蒸馏/04-SDPO-环境反馈蒸馏.md)(环境 rich feedback 自教师;LCBv6 48.8 vs GRPO 41.2;不是塞进 DPO) · [09-MOPD](../../4-后训练/4.6-OPD/09-MOPD-多教师蒸馏/09-MOPD-多教师蒸馏.md)(V4 仍叫 OPD 全词表;K3 clip 对数比;MiMo 训推比 + ORM) · [10-各家报告对照](../../4-后训练/4.6-OPD/10-OPD-各家报告对照/10-OPD-各家报告对照.md)(17920/1800 不要安到 V4) |
| 持续学习 | 已有 | [4.7](../../4-后训练/4.7-持续学习/4.7-持续学习.md)(EWC/LwF/Replay);SDFT 专文在 4.6/03 |
...
| MuonClip / QK-Clip | 已有 | [05-MuonClip 与 Polar Express](../../6-训练与推理优化/6.5-优化器/Muon/05-MuonClip与PolarExpress.md)(含 K3 Per-Head Muon);K2/K3 的发布配方回到第 05 章对应版本正本 |
...
| CLIP / VLM | 已有 | [8.8 CLIP](../../8-多模态/8.8-CLIP与视觉编码器/8.8-CLIP与视觉编码器.md),[8.2.1 LLaVA](../../8-多模态/8.2-视觉语言模型/8.2.1-LLaVA架构深度解析.md) |
...
| RSI / 自进化 | 兄弟花园 | [content/rsi 导读](../../../rsi/_garden.md)(自改进,递归自改进与治理分层;机制不并进第 13 章再写一套) |
...
- Qwen 家族来源边界:[Qwen 家族正本](../../05-模型家族与选型/5.3-模型家族/qwen/qwen.md)(Qwen3.8-Flash-Next 是官方公开的 Qwen4 架构预览,不等同于 Qwen4 正式发布;旧预测稿只在隐藏归档保留)
