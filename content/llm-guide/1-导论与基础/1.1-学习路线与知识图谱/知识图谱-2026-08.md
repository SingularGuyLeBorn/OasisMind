...
| CLIP / VLM | 已有 | [8.8 CLIP](../../8-多模态/8.8-CLIP与视觉编码器/01-CLIP与视觉编码器.md)、[8.2.1 LLaVA](../../8-多模态/8.2-视觉语言模型/8.2.1-LLaVA架构深度解析.md) |
...
- Qwen4 架构预测（无出厂报告）：[14-Qwen4-架构预测](../../14-主流开源模型全景解析与技术报告精读/14.2-Qwen/14-Qwen4-架构预测/14-Qwen4-架构预测.md)
