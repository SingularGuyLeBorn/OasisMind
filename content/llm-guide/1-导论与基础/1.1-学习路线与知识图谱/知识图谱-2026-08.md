...
| 蒸馏 / OPD | 已有 | [4.6 OPD](../../4-后训练/4.6-OPD/4.6-OPD.md) · [01-OPD基础原理](../../4-后训练/4.6-OPD/01-OPD基础原理/01-OPD基础原理.md)（On-Policy Distillation，不是 Online Preference；Table 21 分母：Qwen3-8B / math+code / 17920 vs 1800） · [02-OPSD](../../4-后训练/4.6-OPD/02-OPSD-自蒸馏/02-OPSD-自蒸馏.md)（特权上下文自教师；37.1→43.4 是三集平均） · [03-SDFT](../../4-后训练/4.6-OPD/03-SDFT-自蒸馏持续学习/03-SDFT-自蒸馏持续学习.md)（示范 $d$ 当特权上下文；70.6/65.4 是 Table 5 单任务 Tool Use，不是顺序三任务） · [04-SDPO](../../4-后训练/4.6-OPD/04-SDPO-自蒸馏策略优化/04-SDPO-自蒸馏策略优化.md)（环境 rich feedback 自教师；LCBv6 48.8 vs GRPO 41.2；不是塞进 DPO） · [09-MOPD](../../4-后训练/4.6-OPD/09-MOPD-多教师在线蒸馏/09-MOPD-多教师在线蒸馏.md)（V4 仍叫 OPD 全词表；K3 clip 对数比；MiMo 训推比 + ORM） · [10-报告落地对照](../../4-后训练/4.6-OPD/10-OPD-报告落地对照/10-OPD-报告落地对照.md)（17920/1800 不要安到 V4） |
