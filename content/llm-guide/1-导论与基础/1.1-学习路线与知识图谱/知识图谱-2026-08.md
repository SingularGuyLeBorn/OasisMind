---
title: "知识图谱-2026-08：1–9+13 依赖与主题树落点"
date: 2026-08-30
as_of: 2026-08-30
tags: [知识图谱, 学习路线, GPU, 训练优化]
published: false
excerpt: 前进线地图。第 6 章是优化手法，第 9 章是物理与系统底座。第 5 与 14 是同一章两面。表里只链非空壳。
category: LLM 指南
---
...
第 9 章回答「跑在什么硬件/系统上」；第 6 章回答「怎么优化计算」。第 5 章与第 14 章是**同一章两面**：5 = 选型/演进叙事，14 = 技术报告精读。两边总览互相指一句，不要删任一侧，也不要再写成永远分家。

![前进线骨架 1–9 与 13](./images/fig-chapter-skeleton-2026.png)

> 图 1：本库前进线。第 5 与第 14 章画在同一格。没有第 10–12 章。

**图 1 解析**

- 第 1 章只导航；第 2 章是积木基石，分叉进预训练与后训练。
- 第 9 章喂给第 6 章：先有物理底座，再谈优化手法。
- 出口是第 7 / 8 / 13 章。某次发布怎么捆积木，只在第 5/14 章读。
...
flowchart TB
  ...
  subgraph models [主流模型 · 同一章两面]
    C5_14["第 5 章叙事 + 第 14 章精读"]
  end
  subgraph exits [出口]
    C7["第 7 章 应用"]
    C8["第 8 章 多模态"]
...
档：`已有` = 体系章有可读正文；`薄` = 有文但缺推导/图/2026 事实；`缺专文` = 概念只散落在第 14 章或总览一句。
