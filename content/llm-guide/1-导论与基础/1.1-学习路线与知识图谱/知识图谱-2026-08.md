...
| 蒸馏 / OPD | 已有 | [4.6 OPD](../../4-后训练/4.6-OPD/4.6-OPD.md) · [01-OPD基础原理](../../4-后训练/4.6-OPD/01-OPD基础原理/01-OPD基础原理.md)（On-Policy Distillation，不是 Online Preference；Table 21 分母：Qwen3-8B / math+code / 17920 vs 1800） · [02-OPSD](../../4-后训练/4.6-OPD/02-OPSD-自蒸馏/02-OPSD-自蒸馏.md)（特权上下文自教师；37.1→43.4 是三集平均） |
