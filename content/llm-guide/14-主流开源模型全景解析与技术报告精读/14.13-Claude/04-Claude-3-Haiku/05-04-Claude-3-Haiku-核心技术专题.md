...
上面两段是 2025 占位，**原样保留**。CAI 推导在 [4.4.3](../../../4-后训练/4.4-对齐技术/4.4.3-RLAIF/4.4.3-RLAIF.md) 与 [Claude 1 D2](../01-Claude-1/01-01-Claude-1-架构精译.md)。标题「神经元干预」在 Claude 3 卡里 **没有**。
