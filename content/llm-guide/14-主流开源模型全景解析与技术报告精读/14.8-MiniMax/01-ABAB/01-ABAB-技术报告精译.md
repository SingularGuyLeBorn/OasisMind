...
**材料类型（2026-08）**：同目录 `04-ABAB-mineru-zh.md` 已标 **status: pending**——**没有独立 PDF**。本 01 原先是空壳。数字与产品线写在博文分析里：abab 6（2024-01）国内较早公开的 MoE 通用模型叙事；abab 6.5（2024-04）。**不要**把 DeepSeek 细粒度公式假装成 ABAB 论文 Table 1。mineru 重构稿里的「极有可能采用共享专家」保持猜测，不升级成官方。
