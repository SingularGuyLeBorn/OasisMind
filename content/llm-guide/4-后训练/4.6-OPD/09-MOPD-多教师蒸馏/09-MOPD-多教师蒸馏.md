...
一手：[MiMo-V2-Flash 技术报告](https://arxiv.org/abs/2601.02780) §4.1 与 §4.4；版本身份与边界见 [MiMo-V2-Flash](../../../05-模型家族与选型/5.3-模型家族/mimo/mimo-v2-flash/mimo-v2-flash.md)。**不要**用上一节的 $\mathrm{clip}(\cdot,-R_{\max},R_{\max})$ 去填 Flash 公式里没写的空。
