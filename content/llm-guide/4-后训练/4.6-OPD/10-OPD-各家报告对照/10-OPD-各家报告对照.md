...
- [DeepSeek-V4 身份页](../../../05-模型家族与选型/5.3-模型家族/deepseek/deepseek-v4/deepseek-v4.md) 的 §5.5 应写成:V4 的 multi-teacher OPD 没有 17,920 / 1,800 这组 GPU 小时对照;那两个格子是 Qwen3 Table 21 的,不要安到 V4.
...
- **G-OPD / SCOPE**:表里「本波不展开」.不要把 300 / 800 / 200 GPU 小时当成 V4 报告数字,这组数字没有一手出处.
...
| 把 G-OPD / SCOPE 当 V4 官方阶段 | 无一手出处 | 本波不展开 |
