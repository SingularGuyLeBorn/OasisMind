...
成对分类的正本在 [01-DPO](../../4.4.2-无奖励模型的对齐DPO-KTO/01-DPO/01-DPO.md)。恒等 Ψ 的离线平方在 [03-IPO](../03-IPO-身份偏好优化/03-IPO-身份偏好优化.md)。对比平方接到当前策略、驻点变成 Nash，在 [08-Online IPO](../08-Online-IPO-在线偏好/08-Online-IPO-在线偏好.md)；几何混合在那边是两条回答的采样源，不是这边的对手。近端策略梯度在 [04-PPO](../../4.4.1-基于奖励模型的RL-RLHF-PPO/04-PPO/04-PPO.md)。节地图在 [4.4.4](../4.4.4-其他对齐技术.md)。
