...
3. **K3 / V4。** K3：预训练 MTP 微调成 EAGLE-3 风格 draft，融合 AttnRes 块 1/4/末，损失 $\mathcal{L}_{\mathrm{LK}}$，见 [2.4.6](../../../2-核心原理与架构/2.4-前沿架构与变体/2.4.6-多Token预测MTP深度解析.md)。V4 MTP 与 V3 相同，不是这条微调。图在 [6.6.2](./6.6.2-投机解码.md)。
