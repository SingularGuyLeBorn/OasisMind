---
title: "留一法策略梯度优化 (REINFORCE Leave-One-Out, RLOO)"
category: "强化学习与对齐算法"
tags: [强化学习, 对齐]
published: true
excerpt: "论文信息: - 标题: Back to Basics: Revisiting REINFORCE Style Optimization for Learning from Human Feedback in LLMs - 作者: Arash Ahmadian et al. Cohere For AI"
---
# 留一法策略梯度优化 (REINFORCE Leave-One-Out, RLOO)
...
**前置知识**: REINFORCE(1.1.4 节)、GRPO(1.3.1 节)
...
2. **简化路线**：论文展示了 REINFORCE 配合 leave-one-out 基线在其 RLHF 实验设置中的竞争力
