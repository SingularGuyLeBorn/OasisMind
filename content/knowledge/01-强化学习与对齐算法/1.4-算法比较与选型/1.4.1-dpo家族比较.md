---
title: "DPO Family: 偏好优化算法大比拼"
category: "强化学习与对齐算法"
tags: [强化学习, 对齐]
published: true
excerpt: "本章节汇总了 DPO 及其主要变体IPO, SimPO, ORPO, KTO的核心差异、适用场景及优缺点."
---
...
KTO 引入了心理学权重.
- **特点**: 对 Good 和 Bad 样本赋予不同的权重($\lambda_D$)，模拟人类的损失厌恶. 这使 KTO 能处理类别不平衡，但实际效果取决于权重、数据构成与任务。
