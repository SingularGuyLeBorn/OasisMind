---
title: "近端策略优化 (Proximal Policy Optimization, PPO)"
category: "强化学习与对齐算法"
tags: [强化学习, 对齐]
published: true
excerpt: "论文信息: - 标题: Proximal Policy Optimization Algorithms - 作者: John Schulman, Filip Wolski, Prafulla Dhariwal, Alec Radford, Oleg Klimov OpenAI - 年份: 2017 "
---
...
**前置知识**: 策略梯度定理(1.1.3 节)、REINFORCE(1.1.4 节)
