---
title: "演员-评论家算法 (Actor-Critic)"
category: "强化学习与对齐算法"
tags: [强化学习, 对齐]
published: true
excerpt: "前置知识: - 策略梯度 PG / REINFORCE 1.1.4 节 - 贝尔曼方程 1.1.2 节 - 时间差分学习 Temporal Difference Learning, TD"
---
# 演员-评论家算法 (Actor-Critic)

**前置知识**:
- 策略梯度 (PG) / REINFORCE (1.1.4 节)
- 贝尔曼方程 (1.1.2 节)
...
只要 $b(s_t)$ 不依赖于动作 $a_t$，这个梯度就是无偏的(我们在1.1.4 节已经证明过).
...
本章的Actor-Critic是通往PPO(1.1.7 节)的必经之路. 理解了GAE和Advantage的概念，你就能轻松理解PPO是如何在此基础上通过限制更新步长来进一步稳定训练的.
