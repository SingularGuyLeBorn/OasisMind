---
title: "理论与实践的桥梁: 从公式到迭代 (Theory to Iteration)"
category: "强化学习与对齐算法"
tags: [强化学习, 对齐]
published: true
excerpt: "在我们的简单网格代码中: python ns, r = env.gettransitions, a 这是一个确定性环境概率 $P=1$. 所以在贝尔曼更新中，$\\sum{s'} Ps'|s,a Vs'$ 退化为单项 $1.0 \\times Vns$."
---
