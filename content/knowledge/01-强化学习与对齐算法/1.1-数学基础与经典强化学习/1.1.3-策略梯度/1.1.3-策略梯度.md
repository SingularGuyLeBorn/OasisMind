...
tags: [强化学习, 对齐]
published: true
excerpt: "前置知识要求: 本章假设读者已阅读1.1.1 节概率空间和1.1.2 节贝尔曼方程，理解期望、MDP、价值函数的概念."
---
# 策略梯度定理

**前置知识要求**: 本章假设读者已阅读1.1.1 节(概率空间)和1.1.2 节(贝尔曼方程)，理解期望、MDP、价值函数的概念.
...
在1.1.2 节中，我们学习了贝尔曼方程. 基于价值的方法(如Q-Learning、DQN)通过学习 $Q^*(s, a)$，然后选择 $\arg\max_a Q^*(s, a)$ 来行动.
