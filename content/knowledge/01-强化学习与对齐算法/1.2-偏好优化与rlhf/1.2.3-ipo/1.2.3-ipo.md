...
tags: [强化学习, 对齐]
published: true
excerpt: "论文信息: - 标题: A General Theoretical Paradigm to Understand Learning from Human Preferences - 作者: Mohammad Gheshlaghi Azar, Mark Rowland, Bilal Piot, et "
---
...
- **年份**: 2023
- **论文**: [arXiv:2310.12036](https://arxiv.org/abs/2310.12036)

**前置知识**: DPO(1.2.2 节)、凸优化、KKT条件
