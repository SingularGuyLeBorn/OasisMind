---
title: "优势比偏好优化 (Odds Ratio Preference Optimization, ORPO)"
category: "强化学习与对齐算法"
tags: [强化学习, 对齐]
published: true
excerpt: "论文信息： - 标题：ORPO: Monolithic Preference Optimization without Reference Model - 作者：Jiwoo Hong, Noah Lee, James Thorne KAIST - 年份：2024 - arXiv：2403.07691"
---
...
- **年份**：2024
- **论文**：[arXiv:2403.07691](https://arxiv.org/abs/2403.07691)

**前置知识**：DPO(1.2.2 节)、交叉熵损失

---

## 0. 本章目标

ORPO 于 2024 年提出，将语言建模目标与偏好对的 odds-ratio 损失结合在同一训练阶段。

> **设计动机**：PPO 式 RLHF 和 DPO 通常涉及参考策略；具体显存开销取决于是否预计算 reference log-prob、参数共享、量化与分布式策略，不能统一概括为“翻倍”。
