---
title: "简单偏好优化 (Simple Preference Optimization, SimPO)"
category: "强化学习与对齐算法"
tags: [强化学习, 对齐]
published: true
excerpt: "论文信息: - 标题: SimPO: Simple Preference Optimization with a Reference-Free Reward - 作者: Yu Meng, Mengzhou Xia, Danqi Chen Princeton University - 年份: 2024"
---
...
- **年份**: 2024
- **论文**: [arXiv:2405.14734](https://arxiv.org/abs/2405.14734)

**前置知识**: DPO(1.2.2 节)、最大间隔损失 (Margin Loss)
...
1. **无显式参考模型**：论文实验表明，在其模型、数据与评测设置中，无显式参考模型的目标可以具有竞争力。
