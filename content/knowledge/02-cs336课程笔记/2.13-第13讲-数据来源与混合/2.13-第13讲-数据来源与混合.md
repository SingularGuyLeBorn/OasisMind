---
title: "Lecture 13: 训练数据策略 (Training Data Strategy)"
category: "CS336 课程笔记"
tags: [CS336, 语言模型]
published: true
excerpt: "课程: CS336 · 主题: 预训练、中期训练、后期训练的数据来源与处理"
---
...
**[深入探讨: Common Crawl 与网络爬虫](./2.13.1-common-crawl.md)**
...
**[深入探讨: DCLM 与模型基质量过滤](./2.13.3-dclm.md)**
...
**[深入探讨: 版权法与 Fair Use](./2.13.2-版权与许可.md)**
