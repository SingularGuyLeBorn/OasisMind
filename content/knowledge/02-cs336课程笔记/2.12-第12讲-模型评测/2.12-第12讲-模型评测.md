---
title: "Lecture 12: 模型评估详解 (Deep Dive into Model Evaluation)"
category: "CS336 课程笔记"
tags: [CS336, 语言模型]
published: true
excerpt: "课程: CS336 · 主题: 语言模型评估的哲学、框架与实践"
---
...
- **PhD 专家准确率**: **65%**
- **当时 SOTA (GPT-4)** : **39%**
- **Spring 2025 课堂时点示例（非当前榜单）**：o3 约 **75%**
...
- **Spring 2025 课堂时点示例（非当前榜单）**：o3 约 **20%**
...
**[深入探讨: Chatbot Arena 与 ELO 评分系统](./2.12.2-chatbot-arena.md)**
...
**[深入探讨: Agent 基准: SWE-Bench 与 CyBench](./2.12.1-智能体基准.md)**
...
语言模型在实践中被大量使用。下列数字仅是 Spring 2025 课程材料引用的规模示例；本地未重新核验原始帖文，也不代表当前值:

- OpenAI: 课堂引用值为每天 1000 亿 Token
- Cursor: 课堂引用值为 10 亿行代码
...
**[深入探讨: 训练-测试污染 (Train-Test Contamination)](./2.12.3-评测污染.md)**
