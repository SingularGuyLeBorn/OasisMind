---
title: "ZeRO Stage 3 (FSDP) 的执行机制与通信重叠"
category: "CS336 课程笔记"
tags: [CS336, 语言模型]
published: true
excerpt: "ZeRO Stage 3, 在 PyTorch 中被实现为全分片数据并行 FSDP, Fully Sharded Data Parallel, 是当今训练超大模型的核心技术. 它打破了数据并行的内存墙, 将参数、梯度和优化器状态全部切分到各个 GPU 上."
---
