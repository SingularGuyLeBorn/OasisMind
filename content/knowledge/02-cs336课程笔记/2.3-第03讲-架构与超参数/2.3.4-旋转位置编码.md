---
title: "精英笔记:旋转位置编码 (RoPE)"
category: "CS336 课程笔记"
tags: [CS336, 语言模型]
published: true
excerpt: "在Transformer模型中,让模型理解单词的顺序和相对位置是至关重要的. 旋转位置编码Rotary Position Embeddings, RoPE是当前解决此问题的最先进、最主流的方法. 它通过一种优雅的数学方式,将相对位置信息编码到自注意力机制中."
---
# 精英笔记:旋转位置编码 (RoPE)
