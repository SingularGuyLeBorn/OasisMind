---
title: "CS336 Lecture 9: 详解 Scaling Laws (Scaling Laws Explained)"
category: "CS336 课程笔记"
tags: [CS336, 语言模型]
published: true
excerpt: "我想让你们先进入这样一个场景: 你有一个非常富有的朋友,给了你 100,000 张 H100 GPU 的使用权按月计. 你的任务是构建一个最好的开源语言模型LLM. 这是一个非常艰巨的任务. 虽然我们已经给了你一些工具——你有了基础设施团队、系统人员、分布式训练框架Next Assignment、预"
---
...
**[深入探讨: 扩展定律的统计力学原理](./2.9.4-扩展定律机制.md)**
...
**[深入探讨: Chinchilla IsoFLOP 分析方法论](./2.9.1-chinchilla方法.md)**
