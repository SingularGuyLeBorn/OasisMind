---
title: "Elite Note: 极大更新参数化 (MuP / Maximal Update Parametrization)"
category: "CS336 课程笔记"
tags: [CS336, 语言模型]
published: true
excerpt: "如果实现了这一点,你就可以: 1. 在一个很小的模型Proxy Model,如宽度 128上扫描出最佳 LR. 2. 直接将这个 LR 应用于宽度为 16384 的超大模型. 3. 保证大模型的训练动态Feature Learning是最大化且稳定的."
---
