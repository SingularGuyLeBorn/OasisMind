---
title: "深入探讨: InstructGPT流水线"
category: "CS336 课程笔记"
tags: [CS336, 语言模型]
published: true
excerpt: "本页补充 Lecture 15,详细剖析InstructGPT论文中的三阶段后训练流程,这是理解现代大模型对齐技术的基础."
---
# 深入探讨: InstructGPT流水线

本页补充 Lecture 15,详细剖析InstructGPT论文中的三阶段后训练流程,这是理解现代大模型对齐技术的基础.
