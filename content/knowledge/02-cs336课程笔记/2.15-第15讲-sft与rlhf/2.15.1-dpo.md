...
tags: [CS336, 语言模型]
published: true
excerpt: "本页补充 Lecture 15,完整推导DPO Direct Preference Optimization 的数学原理,解释为何可以绕过显式奖励模型直接从偏好数据优化策略."
---
# 深入探讨: DPO数学推导

本页补充 Lecture 15,完整推导DPO (Direct Preference Optimization) 的数学原理,解释为何可以绕过显式奖励模型直接从偏好数据优化策略.
