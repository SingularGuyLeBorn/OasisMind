---
title: "深入探讨: MinHash与LSH算法"
category: "CS336 课程笔记"
tags: [CS336, 语言模型]
published: true
excerpt: "本页补充 Lecture 14,深入讲解近似去重的数学原理,包括Jaccard相似度、MinHash签名、局部敏感哈希LSH及其理论保证."
---
# 深入探讨: MinHash与LSH算法

本页补充 Lecture 14,深入讲解近似去重的数学原理,包括Jaccard相似度、MinHash签名、局部敏感哈希(LSH)及其理论保证.
