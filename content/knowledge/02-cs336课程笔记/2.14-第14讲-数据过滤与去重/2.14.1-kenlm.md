---
title: "深入探讨: KenLM与N-gram语言模型"
category: "CS336 课程笔记"
tags: [CS336, 语言模型]
published: true
excerpt: "本页补充 Lecture 14,深入讲解N-gram语言模型的数学原理、Kneser-Ney平滑技术,以及KenLM的高效实现."
---
# 深入探讨: KenLM与N-gram语言模型

本页补充 Lecture 14,深入讲解N-gram语言模型的数学原理、Kneser-Ney平滑技术,以及KenLM的高效实现.
