---
title: "深入探讨: DeepSeek R1技术报告"
category: "CS336 课程笔记"
tags: [CS336, 语言模型]
published: true
excerpt: "本页补充 Lecture 16,详细分析DeepSeek R1的技术细节,包括R1-Zero实验、SFT初始化、语言一致性奖励等关键创新."
---
# 深入探讨: DeepSeek R1技术报告

本页补充 Lecture 16,详细分析DeepSeek R1的技术细节,包括R1-Zero实验、SFT初始化、语言一致性奖励等关键创新.
