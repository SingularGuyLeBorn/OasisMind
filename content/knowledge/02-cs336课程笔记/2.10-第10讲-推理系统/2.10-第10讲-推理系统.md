---
title: "Lecture 10: 推理 (Inference)"
category: "CS336 课程笔记"
tags: [CS336, 语言模型]
published: true
excerpt: "主讲人: CS336 Instructor 核心议题: 模型推理的效率瓶颈、算术强度分析、KV Cache优化架构、非Transformer架构、量化与剪枝、投机采样、系统级优化."
---
...
训练是阶段性成本，而推理会随请求持续发生。

> **时点说明**：下列数字是 Spring 2025 课程材料引用的规模示例，不是 2026 年当前统计；本地笔记未独立核验原始帖文。
...
这些课堂示例用于说明推理负载可能很大；两个时点数字不能用来推断线性或指数增长率。优化推理效率会直接影响服务成本、延迟和可扩展性。
...
**[深入探讨: Transformer推理的算术强度与性能建模](./2.10.1-算术强度分析.md)**
...
**[深度分析: 投机采样的概率理论与正确性证明](./2.10.2-投机采样.md)**
