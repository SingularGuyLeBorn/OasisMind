---
title: "精英笔记: Transformer推理的算术强度与性能建模"
category: "CS336 课程笔记"
tags: [CS336, 语言模型]
published: true
excerpt: "本笔记深入解析了 Lecture 10 配套代码 lecture10.py 中的数学模型,详细推导了为何 Transformer 推理特别是生成阶段本质上是内存受限Memory-bound的,并量化了不同架构选择对性能的影响."
---
