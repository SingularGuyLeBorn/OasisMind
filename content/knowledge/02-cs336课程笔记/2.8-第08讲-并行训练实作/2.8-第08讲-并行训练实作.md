---
title: "CS336 第8讲: 手撕大模型并行训练"
category: "CS336 课程笔记"
tags: [CS336, 语言模型]
published: true
excerpt: "上周我们探讨了单个GPU内部的并行计算,本周我们将视野扩展到跨越多GPU和多节点的并行训练."
---
# CS336 第8讲: 手撕大模型并行训练
...
**[深入探讨: 集体通信操作 (Collective Operations)](./2.8.1-集合通信操作.md)**
...
**[深入探讨: 数据并行 DDP 代码实现](./2.8.2-数据并行代码.md)**
...
**[深入探讨: 张量与流水线并行代码实现](./2.8.3-张量与流水线并行代码.md)**
