...
能量模型当 copula 是同期另一条。Guo 等人 2024 本花园没有独立主表。[EDLM](./4.3.2-edlm残差能量.md) 是 Xu 等人 ICLR 2025：残差能量乘在 MDLM 提案上，49% 是 Table 3 GPT-2 2048 步。不要把残差能量和 I-投影写成同一算法。
...
- [CoDD](./4.3.3-codd可算联合层.md)
- [ReFusion](../../06-推理加速与系统/6.3-验证投机与流水线解码/6.3.3-refusion槽级规划.md)
