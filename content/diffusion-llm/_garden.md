...
| 03 知识点 | 五条性质/CART/边际陷阱、块扩散、任意顺序、规划器、提交后能否改、改编、SDAR、D2F、ReFusion、缓存、SlowFast、APD/SSD、copula、CoDD、ParallelBench、serving、量化、Eso-LM、少步蒸馏、dParallel、伪轨迹/AUP、引导、嵌套 SMC、对齐、代码向、离散流、score entropy、失效 |
